...
//        {
//            FlightComputerTelemetryMessage message = new FlightComputerTelemetryMessage();
//            /*
//            message.MagX = (short) 32767;
//            message.MagY = (short) 125;
//            message.MagZ = (short) 32;
//            */
//            Assert.IsTrue(message.MsgType == FlightComputerTelemetryMessage.MessageType);
//            Assert.IsTrue(FlightComputerTelemetryMessage.NumOfBytesInMsg == 7);

//            byte[] bytes = message.GetRawBytes();

//            //verify bytes in the message.
//            Assert.IsTrue(bytes[0] == FlightComputerTelemetryMessage.MessageType);
...
//        {
//            byte[] msgBytes = new byte[FlightComputerTelemetryMessage.NumOfBytesInMsg];

//            msgBytes[0] = FlightComputerTelemetryMessage.MessageType;
...
//            FlightComputerTelemetryMessage telMsg = FlightComputerTelemetryMessage.BuildMessageSt(msgBytes);
//            /*
...
//            Assert.IsTrue(bytes[3] == FlightComputerTelemetryMessage.MessageType);
...
//            FlightComputerTelemetryMessage message2 = (FlightComputerTelemetryMessage)fci.Receive();
...
//            message2 = (FlightComputerTelemetryMessage)fci.Receive();
...
//            mockSPI.Reset();
//            mockSPI.Bytes = bytesCopy;
//            mockSPI.Bytes[3] = FlightComputerTelemetryMessage.MessageType;
//            message2 = (FlightComputerTelemetryMessage)fci.Receive();
//            Assert.IsTrue(message2 != null);
