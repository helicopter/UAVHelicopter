...
//
	...
	///**
	 ...
	 //*/
	//double yawAntiWindup = pidController->calculateIntegralAntiWindup(oldYawControlValue, 0);
	//
	//AssertTrue2(yawAntiWindup == 0, 0);
	//
	////test at .79, .8, .81, -.79, -.8, -.81, 1, -1, .99, -.99
	//AssertTrue2(pidController->calculateIntegralAntiWindup(.79, .79) == 0, 0);
	//AssertTrue2(pidController->calculateIntegralAntiWindup(.80, .80) == 0, 0);
	//
	////.01 * .1 = .001
	//yawAntiWindup = pidController->calculateIntegralAntiWindup(.81, maxYawServoControlValue);
	//AssertTrue2(yawAntiWindup > .0009, 0);
	//AssertTrue2(yawAntiWindup < .0011, 0);
	//
	//AssertTrue2(pidController->calculateIntegralAntiWindup(-.79, -.79) == 0, 0);
	//AssertTrue2(pidController->calculateIntegralAntiWindup(-.8, -.8) == 0, 0);
	//
	//yawAntiWindup = pidController->calculateIntegralAntiWindup(-.81, minYawServoControlValue);
	//AssertTrue2(yawAntiWindup < -.0009, 0);
	//AssertTrue2(yawAntiWindup > -.0011, 0);
	//
	//yawAntiWindup = pidController->calculateIntegralAntiWindup(1.0, maxYawServoControlValue);
	//AssertTrue2(yawAntiWindup > .019, 0);
	//AssertTrue2(yawAntiWindup < .021, 0);
	//
	//yawAntiWindup = pidController->calculateIntegralAntiWindup(-1.0, minYawServoControlValue);
	//AssertTrue2(yawAntiWindup < -.019, 0);
	//AssertTrue2(yawAntiWindup > -.021, 0);
	//
	//
	...
	//
	////.8 +.4 * .15 - .2 = .66
	//double yawIntegral = pidController->calculateIntegral(yawProportional, oldYawIntegral, yawAntiWindup);
	//
	...
	//yawProportional = -.4;
	//yawAntiWindup = -.2;
	//yawIntegral = pidController->calculateIntegral(yawProportional, oldYawIntegral, yawAntiWindup);
	//
	//AssertTrue2(yawIntegral < -.65, 0);
	//AssertTrue2(yawIntegral > -.67, 0);
	//
	...
	//
	//double yawDerivativeError = pidController->calculateVelocityError(yawVelocity, referenceYawVelocity);
	//
	//AssertTrue2(yawDerivativeError == 0, 0);
	//
	//AssertTrue2(pidController->calculateVelocityError(.5, .25) == .25, 0);
	//
	//
	///**
	...
	//double yawControl = pidController->calculateOuterLoopControlValue(yawProportional, yawDerivativeError, yawIntegral);
	...
	//yawIntegral = -.15;
	//
	//yawControl = pidController->calculateOuterLoopControlValue(yawProportional, yawDerivativeError, yawIntegral);
	//AssertTrue2(yawControl == -.2145, 0);
	//
	///*
